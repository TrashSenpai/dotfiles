      ...
      updateAPIStatusUI(isOnline) {
        ...
        if (accountSection) {
          ...
          if (accountInfo) {
            ...
            const statusBorderColor = !isOnline || !pixelBannerPlusServerOnline ? "#FF6B6B" : isConnected ? "#20bf6b" : "#FF0000";
